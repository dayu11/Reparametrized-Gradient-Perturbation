...
parser.add_argument('--method', default='pi', type=str, help='decomposition method, options: power iteration (pi) or random selection (rs)')
...
if args.resume:
    ...
    hyper_params_dict['method'] = args.method
